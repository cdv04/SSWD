...
def calcul_ponderation(data_co, pcat, isp, a, nb_taxo):
    ...
    @parma nom_feuille: nom de la feuille contenant les donnees
                        initiales
    @param nom_colonne: nom des colonnes du tableau data_co tel qu'il
                        sera affiche dans les feuilles de calcul
    ...
    if (isp == 3):
        """
        Si isp=3 (mean), eliminimumation des doublons au niveau espece et
...
def compte_espece(aCollection, p, nb_espece):
