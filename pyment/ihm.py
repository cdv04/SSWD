...
# @Last modified time: 2017-06-16T11:27:48+02:00
...
class mainFrame(wx.Frame):
    ...
    def __init__(self, parent):
        ...
        sizer_file.Add(self.text_input, 0, wx.ALIGN_CENTER_VERTICAL | wx.ALL,
                       5)

        self.filepicker = wx.FilePickerCtrl(
            self, wx.ID_ANY, wx.EmptyString, "Select a file",
            "Data files (*.csv, *.xls, "
            "*.xlsx)|*.csv;*.xls;*.xlsx", wx.DefaultPosition, wx.DefaultSize,
            wx.FLP_DEFAULT_STYLE)
        sizer_file.Add(self.filepicker, 0,
        ...
        sizer_columns.Add(
            self.choice_taxo, 0, wx.ALIGN_CENTER_HORIZONTAL |
        ...
        sizer_columns.Add(
            self.choice_specie, 0, wx.ALIGN_CENTER_HORIZONTAL |
            wx.ALIGN_CENTER_VERTICAL | wx.EXPAND | wx.RIGHT | wx.LEFT, 5)
        ...
        sizer_columns.Add(
            self.choice_ed, 0, wx.ALIGN_CENTER_HORIZONTAL |
            wx.ALIGN_CENTER_VERTICAL | wx.EXPAND | wx.RIGHT | wx.LEFT, 5)
        ...
        self.txt_taxo_weight = wx.StaticText(
            self, wx.ID_ANY, "Taxonomic group weight:", wx.DefaultPosition,
            wx.DefaultSize, 0)
        ...
        sizer_hazen = wx.FlexGridSizer(1, 2, 0, 0)
        sizer_hazen.SetFlexibleDirection(wx.BOTH)
        sizer_hazen.SetNonFlexibleGrowMode(wx.FLEX_GROWMODE_SPECIFIED)

        self.txt_hazen = wx.StaticText(self, wx.ID_ANY, "Hazen parameter:",
                                       wx.DefaultPosition, wx.DefaultSize, 0)
        self.txt_hazen.Wrap(-1)
        sizer_hazen.Add(self.txt_hazen, 0, wx.ALIGN_RIGHT | wx.RIGHT | wx.LEFT,
                        5)

        self.txtc_hazen = wx.TextCtrl(self, wx.ID_ANY, "0.5",
                                      wx.DefaultPosition, wx.DefaultSize, 0)
        sizer_hazen.Add(self.txtc_hazen, 0, wx.RIGHT | wx.LEFT, 5)

        box_option.Add(sizer_hazen, 1, wx.EXPAND, 5)
    ...
    def run(self, event):
        ...
        species, taxon, concentration, test = parse_file(
            self.filename, columns_name, self.txt_sheet_name.GetLabel())
    ...
    def update(self, event):
        ...
        self.txt_output_name.SetLabel(
            basename(
                ...
                (("_" + self.txt_sheet_name.GetLabel()) if self.txt_sheet_name.
                 GetLabel() else "") + "_sswd.xlsx") if self.filename else "")
